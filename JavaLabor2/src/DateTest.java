...
public class DateTest
{
	...
	public void testDateDefault()
	{
		...
		assertTrue(localDate.toString(), "1.1.1970".equals(localDate.toString())
			|| "01.01.1970".equals(localDate.toString()));
	}
	...
	public void testAddDayNormal() throws Exception
	{
		...
		assertEquals("Original Date should not be changed", "20.11.2008",
			testDate.toString());
	}
	...
	public void testAddDayEndOfJanuary() throws Exception
	{
		...
		assertTrue(testDate.toString(), "1.2.2008".equals(testDate.toString())
			|| "01.02.2008".equals(testDate.toString()));
	}
	...
	public void testAddDayEndOfFebruaryNoLeapYear() throws Exception
	{
		...
		Date testDate = localDate.nextDay();
		assertTrue(testDate.toString(), "1.3.2007".equals(testDate.toString())
			|| "01.03.2007".equals(testDate.toString()));
	}
	...
	public void testAddDayEndOfFebruaryLeapYear28() throws Exception
	{
		...
		Date testDate = localDate.nextDay();
		assertTrue(testDate.toString(), "29.2.2000".equals(testDate.toString())
			|| "29.02.2000".equals(testDate.toString()));
	}
	...
	public void testAddDayEndOfFebruaryLeapYear29() throws Exception
	{
		...
		Date testDate = localDate.nextDay();
		assertTrue(testDate.toString(), "1.3.2000".equals(testDate.toString())
			|| "01.03.2000".equals(testDate.toString()));
	}
	...
	public void testAddDayEndOfDecember() throws Exception
	{
		...
		Date testDate = localDate.nextDay();
		assertTrue(testDate.toString(), "1.1.2000".equals(testDate.toString())
			|| "01.01.2000".equals(testDate.toString()));
	}
	/*
	@Test
